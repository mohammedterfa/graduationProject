...
<html>
    ...
    <div class="wrapper">
        ...
        <center>
        <div class="formStyle">
        <form action="addNewAdmin_backend.php" method="post" class="login-form">
            <h1>إضــافة مدير جديد للنظام </h1>
            ...
            <div class="textb">
                ...
                <div class="placeholder">اسم المدير كامل</div>
            </div>

            <div class="textb">
                <input type="email" required name="email">
                <div class="placeholder">الايميل</div>
            </div>
            <div class="textb">
            ...
            <center><button class="btnnew"  name="addNewAdmin" type="submit">إضافة مدير جديد</button>
