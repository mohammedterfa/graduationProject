...
<html>
    ...
    <div class="wrapper">
        ...
        <center>
        <div class="formStyle">
        <form action="updateHospital.php" method="post" class="login-form">
            <h1>حذف وتعديل مستشفى</h1>
            <div class="select" >
                <select name="state">
            ...
            <center><button class="btnnew"  name="udpateHospital" type="submit">تعديل المستشفى</button>
            <center><button class="btnDelete"  name="deleteHospital" type="submit">حذف المستشفى</button>
