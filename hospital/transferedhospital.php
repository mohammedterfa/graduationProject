...
<html>
    ...
    <div class="wrapper">
        ...
        <form action="sendPatientData.php" method="post" class="login-form">
            <h1>التأكد من البيانات </h1>

            <div class="textb">اسم المريض 
                <input type="text" readonly required name="name" value="<?php echo $_SESSION['transfername'] ?>">
                <div class="placeholder"></div>
            </div>
            <div class="textb">الرقم التسلسلي للمريض  
                <input type="text" readonly required name="id" value="<?php echo $_SESSION['transferid'] ?>">
                <div class="placeholder"></div>
            </div> 
            <div class="textb">التحويل من    
                <input type="text" readonly required name="inHosName" value="<?php echo $_SESSION['HosName'] ?>">
                <div class="placeholder"></div>
            </div>
            <div class="textb">إلـى     
                <input type="text" readonly required name="toHosName" value="<?php echo $toHosName ?>">
                <div class="placeholder"></div>
            </div>
            <center><button class="btnnew" style="background-color:green" name="sendData" type="submit">تحويل المريض</button>
            <center><a href="selecthospital.php"><button class="btnnew"  name="" type="button"><i class="fas fa-arrow-circle-left"></i> رجــــوع  </button> </a>
      ...
      if(isset($_GET['status'])){
        if($_GET['status'] == 'success'){
           ?>
               ...
               swal({
                    title: "تمت العملية",
                    text: "تم تحويل المريض بنجاح ... يرجى انتظار الموافقة",
                    icon: "success",
                    button: "تم",
                    });
           ...
           <?php
            ...
            ?>
            swal ( "تلم تتم العملية" ,  "تعذرت عملية التحويل" ,  "error" );
            <?php
        }
      }
      ?>
