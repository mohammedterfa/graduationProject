...
<html>
    ...
    <div class="wrapper">
        ...
        <center>
        <div class="formStyle">
        <form action="selecthospital.php" method="post" class="login-form">
            <h1>التأكد من اسم المريض</h1>

            <div class="textb">
                <input type="text" readonly name="id" value="<?php echo $_SESSION['transfername'] ?>">
                <div class="placeholder"></div>
            </div> 
            <center><button class="btnnew"  name="selecthospital" type="submit">اختيار المستشفى</button>
            <center><a href="transfer.php"><button class="btnnew"  name="" type="button"><i class="fas fa-arrow-circle-left"></i> رجــــوع  </button> </a>
